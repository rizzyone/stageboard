...
namespace PHPSTORM_META {
    ...
    */
    ...
    override(\config(), map([
            ...
            'database.connections.telescope.driver' => 'string',
            'database.connections.telescope.url' => 'NULL',
            'database.connections.telescope.host' => 'string',
            'database.connections.telescope.port' => 'string',
            'database.connections.telescope.database' => 'string',
            'database.connections.telescope.username' => 'string',
            'database.connections.telescope.password' => 'string',
            'database.connections.telescope.charset' => 'string',
            'database.connections.telescope.prefix' => 'string',
            'database.connections.telescope.prefix_indexes' => 'boolean',
            'database.connections.telescope.search_path' => 'string',
            'database.connections.telescope.sslmode' => 'string',
            ...
            'filesystems.links.C:\Users\Ivan\Devel\Rizzyone\viana\public\storage' => 'string',
...
'database.connections.sqlsrv.prefix','database.connections.sqlsrv.prefix_indexes','database.connections.telescope.driver','database.connections.telescope.url','database.connections.telescope.host',
'database.connections.telescope.port','database.connections.telescope.database','database.connections.telescope.username','database.connections.telescope.password','database.connections.telescope.charset',
'database.connections.telescope.prefix','database.connections.telescope.prefix_indexes','database.connections.telescope.search_path','database.connections.telescope.sslmode','database.migrations.table',
...
'filesystems.disks.s3.endpoint','filesystems.disks.s3.use_path_style_endpoint','filesystems.disks.s3.throw','filesystems.disks.s3.report','filesystems.links.C:\\Users\\Ivan\\Devel\\Rizzyone\\viana\\public\\storage',
...
'AWS_DEFAULT_REGION','AWS_BUCKET','AWS_USE_PATH_STYLE_ENDPOINT','VITE_APP_NAME','TELESCOPE_DB_CONNECTION',
'TELESCOPE_DB_HOST','TELESCOPE_DB_PORT','TELESCOPE_DB_DATABASE','TELESCOPE_DB_USERNAME','TELESCOPE_DB_PASSWORD',);
